...
def main():
    ...
    plot_degree_distribution(x_w, y_w, '加边权后的度分布', 'images/加边权后的度分布.png')
    plot_degree_distribution(x_u, y_u, '无边权的度分布', 'images/无边权的度分布.png')

    s_w, d_w = degree_distribution_by_species(graph, weighted=True)
    s_u, d_u = degree_distribution_by_species(graph, weighted=False)
    plot_degree_distribution_by_species(s_w, d_w, '考虑边权的每个物种的度分布', 'images/物种的度分布_weighted.png')
    plot_degree_distribution_by_species(s_u, d_u, '不考虑边权的每个物种的度分布', 'images/物种的度分布_unweighted.png')
