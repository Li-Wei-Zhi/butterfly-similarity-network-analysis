...
edgefile = '/home/kyriedance/Downloads/224W-final-project-master/data/SS-Butterfly_weights.tsv'
nodefile = '/home/kyriedance/Downloads/224W-final-project-master/data/SS-Butterfly_labels.tsv'
...
def confusion_matrix(predictions, labels, title, path):
    ...
    plot_heatmap(confusion_matrix, title, path, '预测的标签', '真实标签')
