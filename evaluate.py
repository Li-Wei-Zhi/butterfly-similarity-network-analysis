...
def arg_parse():
    ...
    parser.add_argument('-c', '--confusion_matrix', default=True, action="store_true",
...
if __name__ == '__main__':
    args = arg_parse()
    main(args)
#python evaluate.py -nf adjacency -m adj__GCN_500_2_64_0.2.pt -t store_true -c store_true
